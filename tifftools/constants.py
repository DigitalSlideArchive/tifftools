...
EXIFTag = TiffConstantSet(TiffTag, {
    ...
    34850: {'datatype': Datatype.SHORT, 'name': 'ExposureProgram'},
    34852: {'datatype': Datatype.ASCII, 'name': 'SpectralSensitivity'},
    34855: {'datatype': Datatype.SHORT, 'name': 'ISO'},
    34858: {'datatype': Datatype.SSHORT, 'name': 'TimeZoneOffset'},
    34859: {'datatype': Datatype.SHORT, 'name': 'SelfTimerMode'},
    34864: {'datatype': Datatype.SHORT, 'name': 'SensitivityType'},
    34865: {'datatype': Datatype.LONG, 'name': 'StandardOutputSensitivity'},
    34866: {'datatype': Datatype.LONG, 'name': 'RecommendedExposureIndex'},
    34867: {'datatype': Datatype.LONG, 'name': 'ISOSpeed'},
    34868: {'datatype': Datatype.LONG, 'name': 'ISOSpeedLatitudeyyy'},
    ...
    37122: {'datatype': Datatype.RATIONAL, 'name': 'CompressedBitsPerPixel'},
    37377: {'datatype': Datatype.SRATIONAL, 'name': 'ShutterSpeedValue'},
    37378: {'datatype': Datatype.RATIONAL, 'name': 'ApertureValue'},
    37379: {'datatype': Datatype.SRATIONAL, 'name': 'BrightnessValue'},
    37380: {'datatype': Datatype.SRATIONAL, 'name': 'ExposureCompensation'},
    37381: {'datatype': Datatype.RATIONAL, 'name': 'MaxApertureValue'},
    37382: {'datatype': Datatype.RATIONAL, 'name': 'SubjectDistance'},
    37383: {'datatype': Datatype.SHORT, 'name': 'MeteringMode'},
    37384: {'datatype': Datatype.SHORT, 'name': 'LightSource'},
    37385: {'datatype': Datatype.SHORT, 'name': 'Flash'},
    37386: {'datatype': Datatype.RATIONAL, 'name': 'FocalLength'},
    ...
    37396: {'datatype': Datatype.SHORT, 'name': 'SubjectArea'},
    37500: {'name': 'MakerNoteUnknown'},
    37510: {'name': 'UserComment'},
    37520: {'datatype': Datatype.ASCII, 'name': 'SubSecTime'},
    37521: {'datatype': Datatype.ASCII, 'name': 'SubSecTimeOriginal'},
    37522: {'datatype': Datatype.ASCII, 'name': 'SubSecTimeDigitized'},
    ...
    40961: {'datatype': Datatype.SHORT, 'name': 'ColorSpace'},
    40962: {'datatype': Datatype.SHORT, 'name': 'ExifImageWidth'},
    40963: {'datatype': Datatype.SHORT, 'name': 'ExifImageHeight'},
    40964: {'datatype': Datatype.ASCII, 'name': 'RelatedSoundFile'},
    41483: {'datatype': Datatype.RATIONAL, 'name': 'FlashEnergy'},
    41486: {'datatype': Datatype.RATIONAL, 'name': 'FocalPlaneXResolution'},
    41487: {'datatype': Datatype.RATIONAL, 'name': 'FocalPlaneYResolution'},
    41488: {'datatype': Datatype.SHORT, 'name': 'FocalPlaneResolutionUnit'},
    41492: {'datatype': Datatype.SHORT, 'name': 'SubjectLocation'},
    41493: {'datatype': Datatype.RATIONAL, 'name': 'ExposureIndex'},
    41495: {'datatype': Datatype.SHORT, 'name': 'SensingMethod'},
    41728: {'name': 'FileSource'},
    41729: {'name': 'SceneType'},
    41730: {'name': 'CFAPattern'},
    41985: {'datatype': Datatype.SHORT, 'name': 'CustomRendered'},
    41986: {'datatype': Datatype.SHORT, 'name': 'ExposureMode'},
    41987: {'datatype': Datatype.SHORT, 'name': 'WhiteBalance'},
    41988: {'datatype': Datatype.RATIONAL, 'name': 'DigitalZoomRatio'},
    41989: {'datatype': Datatype.SHORT, 'name': 'FocalLengthIn35mmFormat'},
    41990: {'datatype': Datatype.SHORT, 'name': 'SceneCaptureType'},
    41991: {'datatype': Datatype.SHORT, 'name': 'GainControl'},
    41992: {'datatype': Datatype.SHORT, 'name': 'Contrast'},
    41993: {'datatype': Datatype.SHORT, 'name': 'Saturation'},
    41994: {'datatype': Datatype.SHORT, 'name': 'Sharpness'},
    41995: {'name': 'DeviceSettingDescription'},
    41996: {'datatype': Datatype.SHORT, 'name': 'SubjectDistanceRange'},
    42016: {'datatype': Datatype.ASCII, 'name': 'ImageUniqueID'},
